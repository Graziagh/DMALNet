...
parser.add_argument('-combine', default='Att', type=str, choices=['RD', 'DR', 'RR', 'DD'],help='combination type (RD)')
parser.add_argument('-extra', type=str, default='_CS-E', metavar='BS', help='(default: 123)')
